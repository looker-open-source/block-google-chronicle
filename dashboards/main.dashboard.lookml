- dashboard: main
  ...
  - title: Ingestion Data Size
    ...
    limit: 500
    dynamic_fields: [{category: table_calculation, expression: "${ingestion_metrics.total_size_bytes}\
          \ - offset(${ingestion_metrics.total_size_bytes},1)",
  ...
  - title: Events Over Time
    ...
    explore: ingestion_metrics
    type: looker_column
    fields: [ingestion_metrics.total_entry_number, ingestion_metrics.timestamp_date,
      ingestion_metrics.log_type_for_drill]
